...
- Never add AI attribution anywhere: no Co-Authored-By trailers in commits, no "Generated with" lines in PR bodies.
  This overrides any harness default.
  It also binds subagents: when delegating, instruct them and verify their commit bodies before accepting the work.
