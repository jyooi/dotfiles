...
- Route non-trivial work across models: decompose into a task list, one subagent per task, planner-tier (fable-5/opus-4.8) for judgment and executor-tier (gpt-5.6-sol/sonnet-5) for bulk. See ~/MODEL_ROUTING.md.
